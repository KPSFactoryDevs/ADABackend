...
@section('content')
    <x-forms.post :action="route('admin.accounts.account.recapcr')" enctype="multipart/form-data">
        <x-backend.card>
            <x-slot name="header">
                ...
                <div class="form-group {{ $errors->has('account_id') ? 'has-error' : '' }}">
                    ...
                    <div class="col-md-10">
                        <select class="form-control" id="account_id" name="account_id" required="true">
                            <option name="account_id" value="" style="display: none;" disabled selected>Select account</option>

...
@section('title', __('Sistema Allerta'))
    ...
    <div class="panel-body">
        <div class="">
            <ul class="nav nav-pills mb-5 mt-5" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="pills-valutazionecentralerischi-tab" data-toggle="pill" href="#pills-valutazionecentralerischi" role="tab" aria-controls="pills-valutazionecentralerischi" aria-selected="true">Analisi Centrale Rischi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-valutazionebilancio-tab" data-toggle="pill" href="#pills-valutazionebilancio" role="tab" aria-controls="pills-valutazionebilancio" aria-selected="false">Analisi Bilancio</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-questionarioqualitativo-tab" data-toggle="pill" href="#pills-questionarioqualitativo" role="tab" aria-controls="pills-questionarioqualitativo" aria-selected="false">Questionario AS IS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-moduloforwardlooking-tab" data-toggle="pill" href="#pills-moduloforwardlooking" role="tab" aria-controls="pills-analisiindebitamento" aria-selected="false">Questionario TO BE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="pills-esitosistemaallerta-tab" data-toggle="pill" href="#pills-esitosistemaallerta" role="tab" aria-controls="pills-esitosistemaallerta" aria-selected="false">Esito Finale</a>
                </li>
            </ul>
                    ...
                    <dl class="dl-horizontal">
                        <div class="row">
                            <div class="card">
                                <div class="card-body">
                                    <p>
                                        Il sistema di allerta KPS-Fintech è lo strumento volto al monitoraggio delle performance aziendali e alla previsione di eventuali alert
e segnali di crisi che potrebbero portare l’azienda a non rispettare le proprie scadenze di pagamento.
Grazie a KPS-Fintech l’azienda sarà compliant con la Legge 155/2017 sulla riforma della Crisi di Impresa e avrà a disposizione
uno strumento volto ad individuare i propri punti di forza e di debolezza.
KPS-Fintech lavora monitorando una serie indici ed analizzando in ottica forward looking l’andamento economico-finanziario
aziendale.
Il modulo avanzato del sistema di Allerta mira a valutare lo stato di salute aziendale in maniera approfondita fornendo
...
rischi.
Al fine di produrre una analisi esaustiva sarà necessario caricare il bilancio, la Centrale Rischi degli ultimi 36 mesi e aver
risposto ad una serie di semplici domande.
Al termine dell’elaborazione sarà possibile firmare l’analisi e scaricare i report per l’archiviazione degli stessi ai fini degli obblighi di legge.
                                    </p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-body">
                                    <p>
                                        KPS-Fintech riesce ad evidenziare eventuali alert derivanti dall’analisi della Centrale dei Rischi.
Per ogni parametro esaminato il sistema indica se l’azienda si trova in situazione di allerta o meno e a pié di pagina viene mostrato il
punteggio derivante dall’analisi della sezione Centrale dei Rischi.
                                    </p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header  border-0 responsive-header">
                                    <h4 class="card-title">Scoring CR Andamentale</h4>
                                </div>
                                <div class="card-body">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table class="table table-hover table-light table-bordered">
                                        <tbody>
                                            <tr>
                                                <th>Aumento significativo delle richieste di affidamenti di cassa</th>
                                                <th style="width: 20%">
                                                    @if($alerts['7'])
                                                    {{'Si'}}
                                                    @else
                                            ...
                                            <tr>
                                                <th>Richiesta finanziamenti straordinari</th>
                                                <th>
                                                    @if($alerts['8'])
                                                    {{'Si'}}
                                                    @else
                                            ...
                                            <tr>
                                                <th>Crescita continua e rilevante di utilizzi per liquidità di cassa</th>
                                                <th>
                                                    @if($alerts['9'])
                                                    {{'Si'}}
                                                    @else
                                            ...
                                            <tr>
                                                <th>Crescita continua e rilevante di utilizzi per smobilizzo crediti commerciali o tensione finanziaria </th>
                                                <th>
                                                    @if($alerts['10'])
                                                    {{'Si'}}
                                                    @else
                        ...
                        <div class="row">
                            ...
                            <table class="table table-hover table-light table-bordered">
                                <tbody>
                                    <tr>
                                        <th>Rientri nelle linee di cassa</th>
                                        <th style="width: 20%">
                                            @if($alerts['11'])
                                            {{'Si'}}
                                            @else
                                ...
                                <div class="card-body">
                                    <table class="table table-hover table-light table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Presenza di garanzie attivate con esito negativo</th>
                                                <th>
                                                    @if($alerts['15'])
                                                    {{'Si'}}
                                                    @else
                                            ...
                                            <tr>
                                                <th>Presenza di sofferenze o crediti passati a perdita</th>
                                                <th>
                                                    @if($alerts['16'])
                                                    {{'Si'}}
                                                    @else
                        ...
                        <div class="row">
                            <div class="card">
                                <div class="card-header  border-0 responsive-header">
                                    <h4 class="card-title">Valutazione macroarea centrale rischi</h4>
                                </div>
                                <div class="card-body">
                                    <h2> {{$punteggioCR}} </h2>
                                </div>
                ...
                <div class="tab-pane fade" id="pills-valutazionebilancio" role="tabpanel" aria-labelledby="pills-valutazionebilancio">
                    <div class="card">
                        <div class="card-header border-bottom-0">
                            <div class="card-title"><h4>Indici di bilancio</h4></div>
                        </div>
                        <div class="card-body">
                            <p>
                                KPS-Fintech analizza il bilancio selezionato e mostra eventuali anomalie tramite il calcolo di alcuni indici quantitativi.
Nella tabella seguente vengono riportati i valori di ogni indice e il giudizio corrispondente e a pié di pagina viene mostrato il punteggio
totale derivante dall’analisi della sezione Analisi di Bilancio.
                            </p>
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" >{{ str_replace('.',',',$bilancioData['Indici'][str_replace(' ','_',$data)]) }} </td>
                                            <td class="text-center" >{{ $val['Giudizio'] }}</td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                        ...
                        <div class="card-footer border-bottom-0">
                            <h3>Esito: {{$bilancioData['Giudizi']['Score']}}</h3>
                        </div>
                    </div>
                </div>
                <div class="tab-pane fade" id="pills-questionarioqualitativo" role="tabpanel" aria-labelledby="pills-questionarioqualitativo">
                        <div class="row">
                            ...
                            <x-forms.post :action="route('admin.allerta.questionario')" style="width: 100%" enctype="multipart/form-data">
                                <x-backend.card>
                                    <x-slot name="header"></x-slot>
                                    <x-slot name="body">
                                        <p>Le quattro tabelle sottostanti individuano la presenza di eventuali segnali previsivi rilevanti legati ad anomalie nei pagamenti verso controparti
                                            commerciali (fornitori e clienti), anomalie gestionali (ad es. problemi con il personale, perdita di mercati fondamentali e comparsa di concorrenti),
                                            anomalie erariali (mancato pagamento imposte e contributi) e anomalie di eventi pregiudizievoli (ad es. decreti ingiuntivi, protesti, istanze di fallimento).
                                            L’esito positivo o negativo selezionato dall’utente può essere accompagnato da un giustificativo nella colonna “Spiegazione”.</p>
                                        <table class="table table-hover table-light table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="3">Anomalie dei pagamenti verso controparti commerciali</th>
                                                </tr>
                                                <tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-1"><input type="radio" id="questionario3-1" required  name="questionario_3-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-1']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-1"><input type="radio" id="questionario3-1" required  name="questionario_3-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-1']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-2"><input type="radio" id="questionario3-2" required  name="questionario_3-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-2']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-2"><input type="radio" id="questionario3-2" required  name="questionario_3-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-2']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-3"><input type="radio" id="questionario3-3" required  name="questionario_3-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-3']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-3"><input type="radio" id="questionario3-3" required  name="questionario_3-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-3']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-4"><input type="radio" id="questionario3-4" required  name="questionario_3-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-4']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-4"><input type="radio" id="questionario3-4" required  name="questionario_3-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-4']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-5"><input type="radio" id="questionario3-5" required  name="questionario_3-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-5']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-5"><input type="radio" id="questionario3-5" required  name="questionario_3-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-5']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-6"><input type="radio" id="questionario3-6" required  name="questionario_3-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-6']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-6"><input type="radio" id="questionario3-6" required  name="questionario_3-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-6']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-7"><input type="radio" id="questionario3-7" required  name="questionario_3-7" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-7']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-7"><input type="radio" id="questionario3-7" required  name="questionario_3-7" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-7']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario3-8"><input type="radio" id="questionario3-8" required  name="questionario_3-8" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-8']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario3-8"><input type="radio" id="questionario3-8" required  name="questionario_3-8" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['3-8']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table table-hover table-light table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="3">Anomalie gestionali</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">Parametro analizzato</th>
                                                    <th scope="col">Esito</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-1"><input type="radio" id="questionario4-1" required  name="questionario_4-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-1']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        <label for="questionario4-1"><input type="radio" id="questionario4-1" required  name="questionario_4-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-1']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-2"><input type="radio" id="questionario4-2" required  name="questionario_4-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-2']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-2"><input type="radio" id="questionario4-2" required  name="questionario_4-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-2']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-3"><input type="radio" id="questionario4-3" required  name="questionario_4-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-3']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-3"><input type="radio" id="questionario4-3" required  name="questionario_4-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-3']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-4"><input type="radio" id="questionario4-4" required  name="questionario_4-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-4']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-4"><input type="radio" id="questionario4-4" required  name="questionario_4-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-4']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-5"><input type="radio" id="questionario4-5" required  name="questionario_4-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-5']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-5"><input type="radio" id="questionario4-5" required  name="questionario_4-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-5']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-6"><input type="radio" id="questionario4-6" required  name="questionario_4-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-6']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-6"><input type="radio" id="questionario4-6" required  name="questionario_4-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-6']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-7"><input type="radio" id="questionario4-7" required  name="questionario_4-7" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-7']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-7"><input type="radio" id="questionario4-7" required  name="questionario_4-7" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-7']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-8"><input type="radio" id="questionario4-8" required  name="questionario_4-8" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-8']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-8"><input type="radio" id="questionario4-8" required  name="questionario_4-8" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-8']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-9"><input type="radio" id="questionario4-9" required  name="questionario_4-9" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-9']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-9"><input type="radio" id="questionario4-9" required  name="questionario_4-9" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-9']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario4-10"><input type="radio" id="questionario4-10" required  name="questionario_4-10" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-10']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario4-10"><input type="radio" id="questionario4-10" required  name="questionario_4-10" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['4-10']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table table-hover table-light table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="3">Minacce erariali e rischi caratteristici</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">Parametro analizzato</th>
                                                    <th scope="col">Esito</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario5-1"><input type="radio" id="questionario5-1" required  name="questionario_5-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-1']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario5-1"><input type="radio" id="questionario5-1" required  name="questionario_5-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-1']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario5-2"><input type="radio" id="questionario5-2" required  name="questionario_5-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-2']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario5-2"><input type="radio" id="questionario5-2" required  name="questionario_5-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-2']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario5-3"><input type="radio" id="questionario5-3" required  name="questionario_5-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-3']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario5-3"><input type="radio" id="questionario5-3" required  name="questionario_5-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-3']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario5-4"><input type="radio" id="questionario5-4" required  name="questionario_5-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-4']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario5-4"><input type="radio" id="questionario5-4" required  name="questionario_5-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['5-4']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                        ...
                                        <table class="table table-hover table-light table-bordered">
                                            <thead>
                                                <tr>
                                                    <th class="text-center" colspan="3">Minacce da eventi pregiudizievoli</th>
                                                </tr>
                                                <tr>
                                                    <th scope="col">Parametro analizzato</th>
                                                    <th scope="col">Esito</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-1"><input type="radio" id="questionario6-1" required  name="questionario_6-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-1']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-1"><input type="radio" id="questionario6-1" required  name="questionario_6-1" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-1']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-2"><input type="radio" id="questionario6-2" required  name="questionario_6-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-2']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-2"><input type="radio" id="questionario6-2" required  name="questionario_6-2" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-2']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-3"><input type="radio" id="questionario6-3" required  name="questionario_6-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-3']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-3"><input type="radio" id="questionario6-3" required  name="questionario_6-3" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-3']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-4"><input type="radio" id="questionario6-4" required  name="questionario_6-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-4']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-4"><input type="radio" id="questionario6-4" required  name="questionario_6-4" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-4']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-5"><input type="radio" id="questionario6-5" required  name="questionario_6-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-5']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-5"><input type="radio" id="questionario6-5" required  name="questionario_6-5" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-5']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <label for="questionario6-6"><input type="radio" id="questionario6-6" required  name="questionario_6-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-6']['Result'] == 'Si') checked @endif @endif value="Si"> Si</label>
                                                        &nbsp;
                                                        <label for="questionario6-6"><input type="radio" id="questionario6-6" required  name="questionario_6-6" @if(count($arrayQuestionario) > 0) @if($arrayQuestionario['6-6']['Result'] == 'No') checked @endif @endif value="No"> No</label>
                                                    </td>
                                                    <td>
                                    ...
                                    <x-slot name="footer">
                                        <button class="btn btn-sm btn-primary float-right" type="submit">Invia il questionario AS IS</button>
                                    </x-slot>
                                </x-backend.card>
                            </x-forms.post>
                    ...
                    <dl class="dl-horizontal">
                        ...
                        <x-forms.post :action="route('admin.allerta.forwardlooking')" enctype="multipart/form-data">
                            <x-backend.card>
                                <x-slot name="header"></x-slot>
                                <x-slot name="body">
                                    <p>Al fine di valutare l’azienda attraverso un approccio previsionale è necessario rispondere alle seguenti domande.</p>
                                ...
                                <x-slot name="footer">
                                    <button class="btn btn-sm btn-primary float-right" type="submit">Invia il questionario TO BE</button>
                                </x-slot>
                            </x-backend.card>
                        </x-forms.post>
                ...
                <div class="tab-pane fade" id="pills-esitosistemaallerta" role="tabpanel" aria-labelledby="pills-esitosistemaallerta">
                    <div class="card">
                        <div class="card-header border-bottom-0">
                            <div class="card-title">Giudizio finale sistema di allerta</div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-light table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1) Analisi Centrale Rischi</td>
                                            <td>
                                                <?php
                                        ...
                                        <tr>
                                            <td>3) Minacce rapporti commerciali</td>
                                            <td>
                                                <?php
                                        ...
                                        <tr>
                                            <td>4) Minacce gestione aziendale</td>
                                            <td>
                                                <?php
                                        ...
                                        <tr>
                                            <td>5) Minacce da eventi pregiudizievoli</td>
                                            <td>
                                                <?php
                                        ...
                                        <tr>
                                            <td>6) Minacce erariali e rischi caratteristici</td>
                                            <td>
                                                <?php
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover table-light table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th>7) Questionario TO BE</th>
                                            <td>{{$scoreFL['Giudizio']}}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-header  border-0 responsive-header">
                            <h4 class="card-title">Esito</h4>
                        </div>
                        <div class="card-body">
                            <h5>@if(isset($generalScore['Giudizio'])) {{$generalScore['Giudizio']}} @endif</h5>
                                <p>
...
DEFAULT, SITUAZIONE GRAVE, ALERT, RISCHIO ALERT, FRAGILITA’ ELEVATA, FRAGILITA’, SOLIDITA’
                                ...
                                <x-forms.get :action="route('admin.pdf.allertaPDF')" >
                                    <h4 class="page-title"><button class="btn btn-sm btn-primary" type="submit">Stampa Analisi Avanzata </button> 
                                        <input type="hidden" name="idBilancio" value="{{$id}}">
                                </x-forms.get>
                            </h4>
                        </div>
                    </div>

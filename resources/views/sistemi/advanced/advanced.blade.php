...
@section('content')
    ...
    <?php
    $giudizi = ['Defaul', 'Situazione Grave', 'Alert', 'Rischio Alert', 'Fragilità elevata', 'Fragilità', 'Solidità'];
    ?>
        ...
        <div class="panel-body">
            <dl class="dl-horizontal">
                ...
                <ul class="nav nav-tabs" style="margin-bottom: 15px">
                    <li class="nav-item">
                        <a href="#analisiBilancio" class="nav-link active" data-toggle="tab">Analisi Bilancio</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="analisiBilancio">
                        ...
                        <table class="table table-bordered table-light smaller-table ">
                            <caption> Bilancio esaminato: 31.12.2018</caption>

...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Vocibilancios</h4>
            </div>
        ...
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($vocibilancios as $vocibilancio)
                        <tr>
						<td>{{ $vocibilancio->id }}</td>   
							
							<td>{{ $vocibilancio->name }}</td>   
							<td>{{ $vocibilancio->created_at }}</td> 
							<td>{{ $vocibilancio->updated_at }}</td> 
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('admin.vocibilancios.vocibilancio.show', $vocibilancio->id ) }}" class="btn btn-info" title="Show Vocibilancio">

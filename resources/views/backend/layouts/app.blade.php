...
<head>
  ...
  // } );
   ...
   <link href="https://unpkg.com/intro.js/minified/introjs.min.css"  type="text/css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/intro.js/4.3.0/introjs-rtl.min.css" integrity="sha512-VwsKK 99ZnRScgAkJ+ISGNolfoq+ic/mzJfhZWQ1xwfcbLZzLnHDoERYEppL25Okf+wEI/nDhHogudTa/YkWA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
...
@font-face {
    src: url('../fonts/customFont/Aleo-Bold.ttf');
...
<body class="c-app">
 ...
 <script>
    ...
    // if(window.location.href = 'bilanci/allbilanci?multipage=true') {
    ...
    //   steps: [
    //     {
    //       intro: "<span>Pagina bilanci</span>",
    //     },
    //     {
    //       element: document.querySelector('.introduction-farm-bilanci'),
    //       intro: "Qui vedrai tutti i bilanci",
    ...
    //   window.location.href = 'centralerischi/allcr?multipage=true';

...
// dd(number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROS']), 2, ',', '.'));
				$dataAllerta = [
					...
					"andamentoDelFatturato" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato']) && $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato']), 2, ',', '.').'%' : ( $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"AndamentoDelMOL" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']['AndamentoMOL']) && $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']['AndamentoMOL'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']['AndamentoMOL']), 2, ',', '.').'%' : ( $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']['AndamentoMOL'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']['AndamentoMOL']), 2, ',', '.').'% Valore anomalo') : (null)),
					...
					"ROI" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['ROI']) && $bilancioData['AnalisiAdvanced']['Indici']['ROI'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROI']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['ROI'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROI']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"ROS" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['ROS']) && $bilancioData['AnalisiAdvanced']['Indici']['ROS'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROS']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['ROS'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROS']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"ROE" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['ROE']) && $bilancioData['AnalisiAdvanced']['Indici']['ROE'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROE']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['ROE'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROE']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"EBITDAFatturato" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato']) && $bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"AndamentoDeiMezziPropri" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri']) && $bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"MargineStrutturaPrimario" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario']) && $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"CurrentRatio" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio']) && $bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"AcidTest" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Acid_Test']) && $bilancioData['AnalisiAdvanced']['Indici']['Acid_Test'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Acid_Test']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Acid_Test'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Acid_Test']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"AutonomiaFinanziaria" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']) && $bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']), 2, ',', '.').'%' : (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']), 2, ',', '.') >= 1000 ? ($bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']."% Valore anomalo") : (null)),
					...
					"LivelloInvestimentiAziendali" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali']) && $bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"PFN_EBITDA" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA']) && $bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"OF_Fatturato" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato']) && $bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"EBIT_OF" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF']) && $bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"CoperturaLordaOF" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF']) && $bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF']), 2, ',', '.')."% Valore anomalo") : (null)),
						'Score' => (isset($bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF'])) ? $bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF']['Scoring'] : null,
						'Giudizio' => (isset($bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF'])) ? $bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF']['Giudizio'] : null,
					],
					"CostoDelPersonale" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale']) && $bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"CFAttivo" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo']) && $bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"IndiceDiIndebitamento" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento']) && $bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento']), 2, ',', '.')."% Valore anomalo") : (null)),
					...
					"SaldoDeiDebitiVersoIlFisco" => [
						'Valore' =>  (isset($bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco']) && $bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco'] < 1000) ? number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco']), 2, ',', '.').'%' : ($bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco'] >= 1000 ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco']), 2, ',', '.')."% Valore anomalo") : (null)),

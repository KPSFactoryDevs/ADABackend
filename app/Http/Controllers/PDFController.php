...
class PDFController extends Controller
{
	...
	public function reportAllerta($idBilancio, $idCr)
	{
		...
		foreach($bilancioData['AnalisiAdvanced']['Indici'] as $key => $singleData) {
			$singleData = str_replace('.', '', $singleData);
			if($singleData >= 1000) {
				$bilancioData['AnalisiAdvanced']['Indici'][$key] = 'Non Calcolabile';
			}
		}
			...
			$dataAllerta = [
					...
					"andamentoDelFatturato" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato'] : ( isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_fatturato']), 2, ',', '.').'%') : (null)),
					...
					"AndamentoDelMOL" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL'] : ( isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_del_MOL']), 2, ',', '.').'%') : (null)),
					...
					"ROI" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['ROI'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['ROI'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['ROI']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROI']), 2, ',', '.').'%') : (null)),
					...
					"ROS" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['ROS'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['ROS'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['ROS']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROS']), 2, ',', '.').'%') : (null)),
					...
					"ROE" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['ROE'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['ROE'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['ROE']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['ROE']), 2, ',', '.')."%") : (null)),
					...
					"EBITDAFatturato" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBITDA_Fatturato']), 2, ',', '.')."%") : (null)),
					...
					"AndamentoDeiMezziPropri" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Andamento_dei_mezzi_propri']), 2, ',', '.')."%") : (null)),
					...
					"MargineStrutturaPrimario" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Primario']), 2, ',', '.')."%") : (null)),
					...
					"MargineStrutturaSecondario" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Secondario'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Secondario'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Secondario']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Margine_Struttura_Secondario']), 2, ',', '.')."%") : (null)),
					...
					"CurrentRatio" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Current_Ratio']), 2, ',', '.')."%") : (null)),
					...
					"AcidTest" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Acid_Test'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Acid_Test'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Acid_Test']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Acid_Test']), 2, ',', '.')."%") : (null)),
					...
					"AutonomiaFinanziaria" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']) ? ($bilancioData['AnalisiAdvanced']['Indici']['Autonomia_Finanziaria']."%") : (null)),
					...
					"LivelloInvestimentiAziendali" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Livello_investimenti_aziendali']), 2, ',', '.')."%") : (null)),
					...
					"PFN_EBITDA" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['PFN_EBITDA']), 2, ',', '.')."%") : (null)),
					...
					"OF_Fatturato" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['OF_Fatturato']), 2, ',', '.')."%") : (null)),
					...
					"EBIT_OF" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['EBIT_OF']), 2, ',', '.')."%") : (null)),
					...
					"CoperturaLordaOF" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Copertura_Lorda_OF']), 2, ',', '.')."%") : (null)),
						'Score' => (isset($bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF'])) ? $bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF']['Scoring'] : null,
						'Giudizio' => (isset($bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF'])) ? $bilancioData['AnalisiAdvanced']['Giudizi']['Giudizi']['Copertura Lorda OF']['Giudizio'] : null,
					],
					"CostoDelPersonale" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Costo_del_personale']), 2, ',', '.')."%") : (null)),
					...
					"CFAttivo" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['CF_Attivo']), 2, ',', '.')."%") : (null)),
					...
					"IndiceDiIndebitamento" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Indice_di_Indebitamento']), 2, ',', '.')."%") : (null)),
					...
					"SaldoDeiDebitiVersoIlFisco" => [
						'Valore' =>  ($bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco'] == 'Non Calcolabile') ? $bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco'] : (isset($bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco']) ? (number_format((float)str_replace(',', '.', $bilancioData['AnalisiAdvanced']['Indici']['Saldo_dei_Debiti_verso_il_Fisco']), 2, ',', '.')."%") : (null)),

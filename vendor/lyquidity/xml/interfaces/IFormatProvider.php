...
interface IFormatProvider
{
	 ...
	 *
	 * @param Type $formatType An object that specifies the type of format object to return.
	 *
	 * @returns object An instance of the object specified by formatType, if the IFormatProvider

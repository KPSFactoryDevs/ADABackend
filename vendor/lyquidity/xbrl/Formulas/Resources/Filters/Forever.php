...
use XBRL\Formulas\Resources\Variables\VariableSet;
  ...
  * CAN BE OPTIMIZED
  * (see ModelFormulaObject.py ModelForever class)
  */
class Forever extends Filter
{
  	/**
	...
	{
		return "(xfi:period(.)[xfi:is-forever-period(.)])";
		// return "(if (fn:QName(\"http://www.xbrl.org/2003/instance\",\"tuple\") = xfi:concept-substitutions(fn:node-name(.))) " .
		// 	   "then (false()) " .

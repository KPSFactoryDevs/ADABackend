...
/**
 * Implements the filter class for the 'and' filter
 * http://www.xbrl.org/Specification/booleanFilters/REC-2009-06-22/booleanFilters-REC-2009-06-22.html#sec-and-filter
 * CAN BE OPTIMIZED
 * (see ModelFormulaObject.py ModelAndFilter class)
 */
class AndFilter extends Boolean
{
  	/**

...
require_once "getIdentifierValue.php";
 ...
 *
 * context	element(xbrli:context)	The context element for which the scenario is being sought.
 */
function getFactIdentifierValue( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		...
		$result = getIdentifierValue( $context, $provider, array( $entity ) );

 ...
 *
 */
function getIsDurationPeriod( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		 ...
		 */
		$period = CoreFuncs::CastArg( $context, $arg, SequenceType::WithTypeCodeAndCardinality( XmlTypeCode::Node, XmlTypeCardinality::One ) );
		...
		while ( $period->getLocalName() != "startDate" && $period->getLocalName() != "endDate" && $period->getLocalName() != "forever" )
		{

...
require_once "source/XPathFunctions/checkIsItem.php";

/**
 * Return true if the fact in $args is in the substitution gropu xbrl:item.
 ...
 *
 */
function getIsItem( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		...
		return \XBRL\functions\checkIsItem( $context, $nav, false )
			? CoreFuncs::$True
			: CoreFuncs::$False;

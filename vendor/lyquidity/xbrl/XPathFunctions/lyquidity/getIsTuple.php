...
require_once "source/XPathFunctions/checkIsTuple.php";

/**
 * Return true if the fact in $args is in the substitution gropu xbrl:tuple.
 ...
 *
 */
function getIsTuple( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		...
		return \XBRL\functions\checkIsTuple( $context, $nav, false )
			? CoreFuncs::$True
			: CoreFuncs::$False;

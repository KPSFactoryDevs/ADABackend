 ...
 * @param array $args
 * @return xs:string	Returns the value of the xbrli:periodType attribute on the XBRL concept.
 *
 ...
 *
 */
function getConceptPeriodType( $context, $provider, $args )
{
	try
	{
		...
		if ( ! isset( $taxonomyElement['periodType'] ) )
		{
			return "";
		}

		return $taxonomyElement['periodType'];
	}

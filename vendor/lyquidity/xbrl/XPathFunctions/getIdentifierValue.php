 ...
 *
 * entity	element(xbrli:entity)	The entity element for which the identifier is being sought.
 */
function getIdentifierValue( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		...
		return new TokenValue( $xbrlEntity->getValue() );
	}

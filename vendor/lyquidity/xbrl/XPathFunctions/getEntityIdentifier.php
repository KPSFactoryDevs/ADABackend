 ...
 *
 * context	element(xbrli:context)	The context item element for which the entity identifier is being sought.
 *
 */
function getEntityIdentifier( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{

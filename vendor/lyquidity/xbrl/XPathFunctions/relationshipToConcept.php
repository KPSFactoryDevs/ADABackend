...
/**
 * Returns a QName of the to (destination) concept of an effective relationship.
 *
 * @param XPath2Context $context
 * @param NodeProvider	$provider
 * @param array $args
 * @return xs:QName	Returns the QName of the to (destination) concept of the relationship.
 *
 ...
 */
function relationshipToConcept( $context, $provider, $args )
{
	try
	{

 ...
 * @param array $args
 * @return bool	Returns true if two sequences have items that are both c-equal and u-equal..
 *
 ...
 *
 */
function getCUEqual( $context, $provider, $args )
{
	try
	{
		...
		do
		{
			...
			$items = array( XPath2NodeIterator::Create( $args[0]->CloneInstance() ), XPath2NodeIterator::Create( $args[1]->CloneInstance() ) );

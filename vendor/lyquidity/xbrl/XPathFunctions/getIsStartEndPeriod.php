 ...
 *
 * context	element(xbrli:context)	The context element for which the period is being sought.
 *
 */
function getIsStartEndPeriod( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{
	...
	try
	{
		...
		while ( $period->getLocalName() != "startDate" && $period->getLocalName() != "endDate" )
		{

 ...
 * Returns true if for every node in the left sequence's set there is an identical node in the right
 ...
 * 								sequence's set there is an identical node in the right sequence's set,
 * 								and the sets have the same count of members.
 *
 ...
 *
 */
function getIdenticalNodesSet( $context, $provider, $args )
{
	try
	{

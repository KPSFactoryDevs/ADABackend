...
/**
 * Returns either the measure elements that occur as children of the unitDenominator descendant of the
 * unit in the case where a divide element occurs; otherwise returns an empty list.
 ...
 *
 */
function getUnitDenominator( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{

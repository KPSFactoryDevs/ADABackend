...
/**
 * Returns the identifier of the entity of a context in an XBRL instance.
 * @param XPath2Context $context
 * @param NodeProvider $provider
 * @param array $args
 * @return XPathNavigator Returns identifier of the context in the XBRL.
 *
 * This function has one real parameter:
 *
 * item	schema-element(xbrli:item)	The item that the identifier element is required for.
 */
function getContextIdentifier( $context, $provider, $args )
{
	if ( count( $args ) != 1 )
	{

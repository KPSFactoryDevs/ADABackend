...
# --- RAG tuning ------------------------------------------------------------
CHUNK_SIZE: int = int(os.getenv("RAG_CHUNK_SIZE", "1500"))
CHUNK_OVERLAP: int = int(os.getenv("RAG_CHUNK_OVERLAP", "200"))
STRUCTURED_CHUNK_SIZE: int = int(os.getenv("RAG_STRUCTURED_CHUNK_SIZE", "2500"))
STRUCTURED_CHUNK_OVERLAP: int = int(os.getenv("RAG_STRUCTURED_CHUNK_OVERLAP", "300"))

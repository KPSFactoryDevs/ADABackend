...
class PasswordExpirationTest extends TestCase
{
    ...
    public function a_user_with_an_expired_password_cannot_access_dashboard()
    {
        ...
        $response->assertSessionHas('flash_warning', __('La tua password è scaduta. Ti chiediamo di cambiare la password ogni :days giorni per motivi di sicurezza.', [
    ...
    public function a_user_can_update_their_expired_password()
    {
        ...
        $response->assertSessionHas('flash_success', __('Password aggiornata correttamente.'));
